...
public class JWTLoginFilter extends AbstractAuthenticationProcessingFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		/*Obter o usuário*/
		ModelLogin user = new ObjectMapper().readValue(request.getInputStream(), ModelLogin.class);
		
		/*Retorna o user com login e senha*/
		return getAuthenticationManager().
				authenticate(new UsernamePasswordAuthenticationToken(user.getNomeSobrenome(), user.getSenha()));
	}
